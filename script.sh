...
tmux send-keys -t $SESSION_NAME:1 "source /home/chambe28/typvenv/bin/activate && cd network-controller && sudo mn -c && sleep 1 && sudo mn --switch ovsk --controller remote --custom ./topology.py --topo testTopology" C-m
